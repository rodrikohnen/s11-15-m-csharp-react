...
import { email, minLength, object, string, regex } from "valibot";
...
const RegisterSchema = object({
  ...
  password: string([
    minLength(6, "Tu password debe tener un mínimo de 6 caracteres"),
    regex(
      passwordRegex,
  ...
  /*   confirmPasword: string([minLength(1, "Ingresa nuevamente tu contraseña")]),
   */
});
