...
const cardFeedbacks = [
  {
    id: 1,
    name: "Mariano Lopez",
    avatar: <Image src={Perfil1} className="rounded-full border border-gray-950" alt="Perfil masculino"/>,
  ...
  },
  {
    id: 2,
    name: "Carlos Aguirre",
    avatar: <Image src={Perfil2} className="rounded-full border border-gray-950" alt="Perfil masculino"/>,
  ...
  },
  {
    id: 3,
    name: "Maria Gomez",
    avatar: <Image src={Perfil3} className="rounded-full border border-gray-950" alt="Perfil femenino"/>,
