  ...
  return (
    <>
      <form className="flex flex-col items-center max-w-100 gap-6 mb-[10rem]">
        <input
          type="text"
          className="border-b-2 border-black w-[17rem]"
        ...
        <div className="flex flex-col gap-5 pt-10">
          <button className="bg-secondary px-16 py-1  rounded-full text-white">
            Editar perfil
          </button>
          <button className="border-2 border-secondary hover:bg-gray-300 rounded-full text-secondary">
            Guardar cambios
          </button>
        </div>
      </form>
